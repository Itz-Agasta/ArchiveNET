...
const subscriptionPlans: SubscriptionPlan[] = [
    ...
    },
    {
        ...
        name: "Pro",
        price: 10,
        features: ["5 Users", "100GB Storage", "Priority Support", "Advanced Features", "Analytics"],
        popular: true
    },
    {
        id: "enterprise",
        name: "Enterprise",
        price: 50,
        features: ["Unlimited Users", "1TB Storage", "24/7 Support", "All Features", "Custom Integrations", "SLA"]
    }
];
...
export function Web3Payment() {
    ...
    const ethAmount = selectedPlan && ethPrice ? convertUsdToEth(selectedPlan.price, ethPrice) : 0;
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-zinc-800 rounded-lg p-6 space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-xl font-bold text-white">${selectedPlan.price} USD</span>
                            </div>
                        ...
                        <div className="space-y-4">
                            {isConnected ? (
                                <Button
                                    ...
                                    disabled={isPaying || isTxLoading || isTxSuccess || !ethPrice || !RECIPIENT_ADDRESS}
            ...
            <div className="bg-zinc-900/50 border border-zinc-700 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-gray-400">
                        ...
                        <p>Your payment is processed directly on the blockchain. Make sure you&apos;re connected to the correct network and have sufficient ETH for gas fees.</p>
                    </div>
                </div>
            </div>
        </div>
